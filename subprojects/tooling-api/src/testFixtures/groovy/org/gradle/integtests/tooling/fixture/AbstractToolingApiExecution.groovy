...
abstract class AbstractToolingApiExecution extends AbstractMultiTestRunner.Execution implements ToolingApiClasspathProvider {
    ...
    AbstractToolingApiExecution(ToolingApiDistribution toolingApi, GradleDistribution gradle) {
